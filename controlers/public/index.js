...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (DATA.status) {
        ...
        DATA.dataset.forEach(row => {
            ...
            let url = `producto.html?id=${row.id_categoria_hoodie}&nombre=${row.nombre_categoria}`;
            // Se crean y concatenan las tarjetas con los datos de cada categoría.
            CATEGORIAS.innerHTML += `
                <div class="col-sm-12 col-md-6 col-lg-3 mb-5 mt-2" >
                    <div class="card mb-3" id="cards">
                        <img src="${SERVER_URL}images/categorias/${row.img_categoria}" class="card-img-top" alt="${row.nombre_categoria}">
